const translations = {
  en: {
    ...
    newton1Desc: "For the development of the hardware system, the primary objectives were a cost-effective and modular system, which created a need for simplicity. We therefore chose a very linear and modular system composed of the following key elements:",
  ...
  fr: {
    ...
    newtonOverview1: "Le projet Newton était un projet de fin d’études interdisciplinaire visant la création d’une plateforme robotique quadrupède accessible, modulaire et peu chère. Son objectif principal était de réduire la barrière à l’entrée pour les étudiants, les hobbyists et les chercheurs intéressés par la locomotion quadrupède et la robotique avancée, au-delà des plateformes d’initiation telles que Arduino et autres solutions simples.",
    newtonOverview2: "En termes pratiques, le projet visait à livrer un robot quadrupède entièrement fonctionnel avec 12 degrés de liberté, des pièces imprimables en 3D, de l'électronique bon marché mais fonctionnels, et une interchangeabilité élevée des composants, ainsi qu'une plateforme logicielle pour un système d'apprentissage par renforcement (Reinforcement Learning). Le projet a été réalisé par une équipe de 7 étudiants en ingénierie de différents domaines.",
    newtonOverview3: "Mon rôle dans l'équipe était en tant que principal concepteur du système électrique, hardware et micrologiciel, avec des tests itératifs et l'intégration de nombreux moteurs, drivers et systèmes d'encodeurs, une grande quantité de câblage, d'assemblage et de soudure, ainsi qu'une utilisation importante des protocoles de communication et des logiciels embarqués de bas niveau. Cela a également été mené en parallèle avec le reste de l'équipe, allant de la conception mécanique à la mise en œuvre du logiciel et du RL.",
    
    newton1Title: "Hardware",
    newton1Desc: "Pour le développement du système électronique/hardware, les objectifs principaux étaient de concevoir un système modulaire et peu cher, ce qui a créé un besoin de simplicité. Nous avons donc choisi une architecture simple et modulaire, composée des éléments suivants:",
    ...
    newton1Item2Desc: "Nous avons testé de manière itérative 7 pilotes moteurs différents, en évaluant l'efficacité, le coût, la fiabilité, mais surtout l'utilisabilite dans notre cas, car nous avons réalisé que la plupart des pilotes BLDC sont conçus pour la haute vitesse, par exemple pour les avions et les drones, alors que nous avions besoin de puissance et de précision. Nous avons finalement sélectionné l'O-Drive S1, visible à droite.",
    ...
    newton1Item4Desc: "Le système d'alimentation était initialement une bloc d'alimentation, mais à mesure que nos besoins évoluaient et que la consommation de courant devenait un problème, nous avons opté pour une batterie Lipo 6S, permettant des systèmes sans fil et un courant de crête plus élevé.",
    
    newton2Title: "Contrôle et microprogrammation",
    newton2Desc: "L’objectif, au niveau du contrôle et des systèmes embarqués, était une fois de plus d'établir une solution simple et modulaire, permettant un apprentissage plus simple et des modifications plus faciles.",
    newton2Item1: "Couches de contrôle hiérarchiques : boucle moteur à 8 kHz, contrôle des articulations à 50 Hz, perception à 30 Hz",
    newton2Item2: "Intergiciel basé sur ROS 2 exécuté sur un Jetson Orin Nano",
    newton2Item3: "Logs en temps réel, détection des défaillances et gestion des mécanismes de sécurité",
    
    newton3Title: "Simulation and RL",
    newton3Item1: "Entraînement par apprentissage par renforcement (RL) à l’aide d’Isaac Sim, puis de Genesis, avec de meilleurs résultats",
    newton3Item2: "Randomisation du domaine (friction, masse, terrain) afin de réduire l’écart de transfert simulation-réel",
    newton3Item3: "Composants de simulation modulaires (environnement, tâche, agent)",
